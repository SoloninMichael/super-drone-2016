...
public:
	...
	virtual void detectFlash(InputArray image, std::vector<KeyPoint>& keypoints, std::vector<int>& num_flash, std::vector<int>& last_flash, int frame);
...
private:
	...
	const double minInertiaRatio = 0.;
